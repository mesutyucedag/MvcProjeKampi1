...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator : AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterMail).NotEmpty().WithMessage("Mail hesabını boş bırakamazsınız.");
            RuleFor(x => x.WriterMail).MinimumLength(5).WithMessage("Lütfen geçerli bir mail adresi girin");
        }
    }
}
